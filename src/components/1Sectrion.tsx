    ...
    <div className="mx-auto container px-5 mb-10 md:mb-0 py-8">
      <div className="flex flex-col-reverse md:flex-row items-center justify-between">
        <div className="max-w-[860px]">
          <h1 className="font-bold leading-11 lg:text-2xl text-2xl mb-4"></h1>
          ...
          <Link href="/about">
            <button type="button" className="h-15 text-center bg-[#ffef3b] l-button text-sm text-[#2a2a2c] font-semibold l-transition rounded-lg  px-4 flex-center align-center cursor-pointer relative hover:-translate-y-1 l-button-primary min-w-[163px] " >
